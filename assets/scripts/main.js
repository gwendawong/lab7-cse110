...
function initFormHandler() {
	...
	const subB = document.querySelector('button[type="submit"]');
	subB.addEventListener('click', () => {
		...
		const old = getRecipesFromStorage();
		old.push(recipeObject);
		saveRecipesToStorage(old);
	});
	
	// B10. TODO - Get a reference to the "Clear Local Storage" button
	const clsB = document.querySelector('button[type="button"]');
